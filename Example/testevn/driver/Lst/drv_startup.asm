...
/* Initialize the normal stack pointer from the linker definition. */
    lrw a1, __StackTop
   a:	1035      	lrw      	r1, 0x0	// 5c <__exit+0x6>
    mov sp, a1
   c:	6f87      	mov      	r14, r1
 ...
 */
	lrw	r1, __erodata
   e:	1035      	lrw      	r1, 0x0	// 60 <__exit+0xa>
	lrw	r2, __data_start__
  10:	1055      	lrw      	r2, 0x0	// 64 <__exit+0xe>
	lrw	r3, __data_end__
  12:	1076      	lrw      	r3, 0x0	// 68 <__exit+0x12>
...
.L_loop0:
	ldw	r0, (r1, 0)
  1a:	9100      	ld.w      	r0, (r1, 0x0)
	stw	r0, (r2, 0)
  1c:	b200      	st.w      	r0, (r2, 0x0)
	addi	r1, 4
  1e:	2103      	addi      	r1, 4
	addi	r2, 4
  20:	2203      	addi      	r2, 4
 ...
 */
  ...
  28:	1031      	lrw      	r1, 0x0	// 6c <__exit+0x16>
	lrw	r2, __bss_end__
  2a:	1052      	lrw      	r2, 0x0	// 70 <__exit+0x1a>
...
.L_loop1_done:
  ...
  3e:	100e      	lrw      	r0, 0x0	// 74 <__exit+0x1e>
        mtcr   r0, cr<15, 1>
  ...
  4a:	c000643f 	mtcr      	r0, cr<31, 0>
	...
	bsr	SystemInit
  4e:	e0000000 	bsr      	0x0	// 0 <SystemInit>
	lrw    r0, VIC_TSPR
	movi   r1, 0xb00
	stw    r1, (r0)
#endif
