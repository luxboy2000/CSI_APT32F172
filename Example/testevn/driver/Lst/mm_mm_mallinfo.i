# 1 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/libs/mm/mm_mallinfo.c"
...
# 1 "<command-line>"
# 1 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/libs/mm/mm_mallinfo.c"
# 40 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/libs/mm/mm_mallinfo.c"
...
# 41 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/libs/mm/mm_mallinfo.c" 2
...
# 43 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/libs/mm/mm_mallinfo.c" 2
...
# 44 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/libs/mm/mm_mallinfo.c" 2
...
# 45 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/libs/mm/mm_mallinfo.c" 2
...
#undef EXTERN
# 46 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/libs/mm/mm_mallinfo.c" 2




#define THIS_MODULE MODULE_MEM_HEAP
# 72 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/libs/mm/mm_mallinfo.c"
int mm_mallinfo(struct mm_heap_s *heap, struct mallinfo *info)
{
...
#define region 0
# 92 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/libs/mm/mm_mallinfo.c"
    {
      ...
      for (node = heap->mm_heapstart[0];
           node < heap->mm_heapend[0];
           node = (struct mm_allocnode_s *)((char *)node + node->size))
        {
          ...
          if ((node->preceding & 0x80000000) != 0)
            {
              uordblks += node->size;
            }
          else
...
static int g_max_size_base = 24576 - 1024 * 2;
int mm_max_usedsize_update(struct mm_heap_s *heap)
{
