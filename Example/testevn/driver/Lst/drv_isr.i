# 1 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/csi_driver/drv/isr.c"
...
# 1 "<command-line>"
# 1 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/csi_driver/drv/isr.c"
# 17 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/csi_driver/drv/isr.c"
...
# 28 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/csi_driver/include/apt_common.h" 2




# 31 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/csi_driver/include/apt_common.h"
typedef enum {
...
# 18 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/csi_driver/drv/isr.c" 2
...
# 19 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/csi_driver/drv/isr.c" 2
...
# 23 "f:\\appl\\c-sky\\cdk\\csky\\mingw\\csky-abiv2-elf-toolchain\\lib\\gcc\\csky-elfabiv2\\6.3.0\\include-fixed\\stdlib.h" 3 4
typedef struct
{
 int quot;
 int rem;
...
# 20 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/csi_driver/drv/isr.c" 2
...
# 327 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/csi_driver/include/apt_gpio.h"
                                                      enable);
# 21 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/csi_driver/drv/isr.c" 2
...
__attribute__((weak)) void ck_coret_irqhandler(void) {
    ({ unsigned int __v = (*(volatile unsigned int *) (0xE000E010)); __v; });
}
...
__attribute__((weak)) void isr_ifc_irqhandler(void) {

}

__attribute__((weak)) void isr_adc_irqhandler(void) {

}

__attribute__((weak)) void isr_tc0_0_irqhandler(void) {

}

__attribute__((weak)) void isr_tc0_1_irqhandler(void) {

}

__attribute__((weak)) void isr_tc0_2_irqhandler(void) {

}

__attribute__((weak)) void isr_tc1_irqhandler(void) {

}

__attribute__((weak)) void isr_tc2_irqhandler(void) {

}

__attribute__((weak)) void isr_tc3_irqhandler(void) {

}

__attribute__((weak)) void isr_led_irqhandler(void) {

}

__attribute__((weak)) void isr_epwm_irqhandler(void) {
...
__attribute__((weak)) void isr_usart_irqhandler(void)
{

}

__attribute__((weak)) void isr_uart_irqhandler(void)
{

}

__attribute__((weak)) void isr_i2c_irqhandler(void)
{

}

__attribute__((weak)) void isr_spi_irqhandler(void)
{

}

__attribute__((weak)) void isr_tkey_irqhandler(void)
{

}

__attribute__((weak)) void isr_comp0_irqhandler(void)
{

}

__attribute__((weak)) void isr_comp1_irqhandler(void)
{
...
{
# 159 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/csi_driver/drv/isr.c"
    ck_coret_irqhandler();

}

__attribute__((isr)) void SYSCON_IRQHandler(void)
{
    ;
...
__attribute__((isr)) void IFC_IRQHandler(void)
{
    ;
    isr_ifc_irqhandler();
    ;
...
__attribute__((isr)) void TC0_0_IRQHandler(void)
{
    ;
...
__attribute__((isr)) void TC0_1_IRQHandler(void)
{
    ;
...
__attribute__((isr)) void TC0_2_IRQHandler(void)
{
    ;
...
__attribute__((isr)) void TC1_IRQHandler(void)
{
    ;
    isr_tc1_irqhandler();
    ;
...
__attribute__((isr)) void TC2_IRQHandler(void)
{
    ;
    isr_tc2_irqhandler();
    ;
...
__attribute__((isr)) void TC3_IRQHandler(void)
{
    ;
    isr_tc3_irqhandler();
    ;
...
__attribute__((isr)) void LED_IRQHandler(void)
{
    ;
    isr_led_irqhandler();
    ;
...
__attribute__((isr)) void EPWM_IRQHandler(void)
{
    ;
    isr_epwm_irqhandler();
    ;
...
__attribute__((isr)) void EXI0_IRQHandler(void)
{
    ;
...
__attribute__((isr)) void EXI1_IRQHandler(void)
{
    ;
...
__attribute__((isr)) void EXI2_IRQHandler(void)
{
    ;
...
__attribute__((isr)) void EXI3_IRQHandler(void)
{
    ;
...
__attribute__((isr)) void EXI4_IRQHandler(void)
{
    ;
...
__attribute__((isr)) void TKEY_IRQHandler(void)
{
    ;
...
__attribute__((isr)) void CMP0_IRQHandler(void)
{
    ;
...
__attribute__((isr)) void CMP1_IRQHandler(void)
{
    ;
