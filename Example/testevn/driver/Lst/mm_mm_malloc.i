# 1 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/libs/mm/mm_malloc.c"
...
# 1 "<command-line>"
# 1 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/libs/mm/mm_malloc.c"
# 40 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/libs/mm/mm_malloc.c"
...
# 41 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/libs/mm/mm_malloc.c" 2

# 1 "f:\\appl\\c-sky\\cdk\\csky\\mingw\\csky-abiv2-elf-toolchain\\csky-elfabiv2\\sys-include\\assert.h" 1 3 4
...
# 10 "f:\\appl\\c-sky\\cdk\\csky\\mingw\\csky-abiv2-elf-toolchain\\csky-elfabiv2\\sys-include\\assert.h" 2 3 4
# 21 "f:\\appl\\c-sky\\cdk\\csky\\mingw\\csky-abiv2-elf-toolchain\\csky-elfabiv2\\sys-include\\assert.h" 3 4
#define __ASSERT_FUNC __func__
# 31 "f:\\appl\\c-sky\\cdk\\csky\\mingw\\csky-abiv2-elf-toolchain\\csky-elfabiv2\\sys-include\\assert.h" 3 4
#undef assert
...
# 38 "f:\\appl\\c-sky\\cdk\\csky\\mingw\\csky-abiv2-elf-toolchain\\csky-elfabiv2\\sys-include\\assert.h" 3 4
extern void __assert_fail (const char *__function, unsigned int __line,
   const char *__file, const char *__assertion)
     __attribute__ ((__noreturn__));

#define assert(__e) ((__e) ? (void)0 : __assert_fail (__FILE__, __LINE__, __ASSERT_FUNC, #__e))
# 43 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/libs/mm/mm_malloc.c" 2
...
# 44 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/libs/mm/mm_malloc.c" 2
...
# 45 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/libs/mm/mm_malloc.c" 2
...
#undef EXTERN
# 46 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/libs/mm/mm_malloc.c" 2




#define THIS_MODULE MODULE_MEM_HEAP
# 60 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/libs/mm/mm_malloc.c"
extern void mm_leak_dump(void);
void mm_record_minfree(void);
# 93 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/libs/mm/mm_malloc.c"
void *mm_malloc(struct mm_heap_s *heap, size_t size, void *caller)
{
  struct mm_freenode_s *node;
  void *ret = 
# 96 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/libs/mm/mm_malloc.c" 3 4
             0
# 96 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/libs/mm/mm_malloc.c"
                 ;
  int ndx;
  ...
  if (size < 1)
    {
      return 
# 106 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/libs/mm/mm_malloc.c" 3 4
            0
# 106 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/libs/mm/mm_malloc.c"
                ;
    }
# 119 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/libs/mm/mm_malloc.c"
  size = (((size + 8) + ((1 << 4)-1)) & ~((1 << 4)-1));
...
# 178 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/libs/mm/mm_malloc.c"
      remaining = node->size - size;
      if (remaining >= (8 + 2*sizeof(struct mm_freenode_s *)))
        {
          ...
          next->preceding = remaining | (next->preceding & 0x80000000);
      ...
      node->preceding |= 0x80000000;
      ret = (void *)((char *)node + 8);
    }
# 225 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/libs/mm/mm_malloc.c"
  ;
  if (!ret) {
