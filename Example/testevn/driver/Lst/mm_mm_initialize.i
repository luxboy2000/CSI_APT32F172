# 1 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/libs/mm/mm_initialize.c"
...
# 1 "<command-line>"
# 1 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/libs/mm/mm_initialize.c"
# 40 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/libs/mm/mm_initialize.c"
...
# 41 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/libs/mm/mm_initialize.c" 2

# 1 "f:\\appl\\c-sky\\cdk\\csky\\mingw\\csky-abiv2-elf-toolchain\\csky-elfabiv2\\sys-include\\string.h" 1 3 4
# 10 "f:\\appl\\c-sky\\cdk\\csky\\mingw\\csky-abiv2-elf-toolchain\\csky-elfabiv2\\sys-include\\string.h" 3 4
...
# 13 "f:\\appl\\c-sky\\cdk\\csky\\mingw\\csky-abiv2-elf-toolchain\\csky-elfabiv2\\sys-include\\string.h" 2 3 4
...
#undef __need_NULL
# 15 "f:\\appl\\c-sky\\cdk\\csky\\mingw\\csky-abiv2-elf-toolchain\\csky-elfabiv2\\sys-include\\string.h" 2 3 4
...
# 43 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/libs/mm/mm_initialize.c" 2
...
# 44 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/libs/mm/mm_initialize.c" 2
...
# 46 "g:\\sw_home\\csky\\csi\\apt32f172a\\csi_apt32f172\\source\\libs\\include\\mm.h" 2
...
#undef EXTERN
# 46 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/libs/mm/mm_initialize.c" 2
...
static size_t g_mmheap_pool[24576 / 4];
# 85 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/libs/mm/mm_initialize.c"
void mm_addregion(struct mm_heap_s *heap, void *heapstart,
                  size_t heapsize)
{
  struct mm_freenode_s *node;
...
#define IDX 0
# 110 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/libs/mm/mm_initialize.c"
  heapbase = ((((uintptr_t)heapstart) + ((1 << 4)-1)) & ~((1 << 4)-1));
  heapend = (((uintptr_t)heapstart + (uintptr_t)heapsize) & ~((1 << 4)-1));
...
# 128 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/libs/mm/mm_initialize.c"
  heap->mm_heapstart[0] = (struct mm_allocnode_s *)heapbase;
  heap->mm_heapstart[0]->size = 8;
  heap->mm_heapstart[0]->preceding = 0x80000000;

  node = (struct mm_freenode_s *)(heapbase + 8);
  node->size = heapsize - 2*8;
  node->preceding = 8;

  heap->mm_heapend[0] = (struct mm_allocnode_s *)(heapend - 8);
  heap->mm_heapend[0]->size = 8;
  heap->mm_heapend[0]->preceding = node->size | 0x80000000;
...
# 170 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/libs/mm/mm_initialize.c"
void mm_initialize(struct mm_heap_s *heap, void *heapstart,
                   size_t heapsize)
{
  int i;
# 189 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/libs/mm/mm_initialize.c"
  heap->mm_heapsize = 0;
  ...
  memset(heap->mm_nodelist, 0, sizeof(struct mm_freenode_s) * (22 - 4 + 1));
  for (i = 1; i < (22 - 4 + 1); i++)
    {
...
{
    mm_initialize(&g_mmheap, &g_mmheap_pool, 24576);
}
