# 1 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/csi_driver/drv/dw_ifc.c"
...
# 1 "<command-line>"
# 1 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/csi_driver/drv/dw_ifc.c"
# 18 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/csi_driver/drv/dw_ifc.c"
...
# 19 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/csi_driver/drv/dw_ifc.c" 2
...
# 20 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/csi_driver/drv/dw_ifc.c" 2
...
# 21 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/csi_driver/drv/dw_ifc.c" 2
# 1 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/csi_driver/include/apt_ifc.h" 1
# 19 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/csi_driver/include/apt_ifc.h"
#define _CSI_IFC_H_ 
...
# 27 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/csi_driver/include/apt_ifc.h" 2
...
typedef void (*ifc_event_cb_t)(ifc_event_e event);
...
# 168 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/csi_driver/include/apt_ifc.h"
int32_t csi_ifc_cb_init (ifc_event_cb_t cb);
# 182 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/csi_driver/include/apt_ifc.h"
uint32_t csi_ifc_program (uint32_t addr, uint32_t size, uint32_t *ptrBuf);
# 199 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/csi_driver/include/apt_ifc.h"
uint32_t csi_ifc_byte_program (uint32_t addr, uint32_t size, uint8_t *ptrBuf);
# 214 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/csi_driver/include/apt_ifc.h"
uint32_t csi_ifc_read(uint32_t addr, uint32_t size, uint32_t *ptrBuf);
# 228 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/csi_driver/include/apt_ifc.h"
uint32_t csi_ifc_byte_read(uint32_t addr, uint32_t size, uint8_t *ptrBuf);
# 241 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/csi_driver/include/apt_ifc.h"
uint32_t csi_ifc_page_erase(ifc_page_adr addr, uint32_t size);
# 22 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/csi_driver/drv/dw_ifc.c" 2

# 1 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/csi_driver/drv/include/lib.h" 1
void mdelay(uint32_t ms);
# 24 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/csi_driver/drv/dw_ifc.c" 2

#define ERR_IFC(errno) (CSI_DRV_ERRNO_IFC_BASE | errno)
#define IFC_NULL_PARAM_CHK(para) do { if (para == NULL) { return ERR_IFC(DRV_ERROR_PARAMETER); } } while (0)
...
ifc_reg_ptr H_IFC = (APT_IFC_Reg_t *)((0x40000000UL)+0x10000UL);
...
# 53 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/csi_driver/drv/dw_ifc.c"
int32_t csi_ifc_cb_init (ifc_event_cb_t cb)
{
 do { if (cb == 
# 55 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/csi_driver/drv/dw_ifc.c" 3 4
0
# 55 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/csi_driver/drv/dw_ifc.c"
) { return (0x81180000 | DRV_ERROR_PARAMETER); } } while (0);
 ifc_event_cb = cb;
...
# 75 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/csi_driver/drv/dw_ifc.c"
uint32_t csi_ifc_program (uint32_t addr, uint32_t size, uint32_t *ptrBuf)
{
 if (size<1) {
  return (0x81180000 | DRV_ERROR_PARAMETER);
 }
 ...
 for (uint32_t i=0;i<size;i++)
 {
  ...
  ((H_IFC)->KR = (0x5A5A5A5Aul));
  H_IFC->CMR = CMD_PGM;
  ((H_IFC)->CR = 1ul);
  while (H_IFC->CR != 0);
  csi_ifc_read (addr_priv,1,&read_back);
  if (ptrBuf[i] != read_back) {
   return (0x81180000 | DRV_ERROR_SPECIFIC0);
  }
  addr_priv += 4;
 }
 ((H_IFC)->CEDR = 0);
...
# 117 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/csi_driver/drv/dw_ifc.c"
uint32_t csi_ifc_byte_program (uint32_t addr, uint32_t size, uint8_t *ptrBuf)
{
 if (size<1) {
  return (0x81180000 | DRV_ERROR_PARAMETER);
 ...
 for (uint32_t i=0;i<size;i++)
 {
  ...
  ((H_IFC)->CR = 1ul);
  while (H_IFC->CR != 0);
  csi_ifc_byte_read (addr,1,&read_back);
...
# 166 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/csi_driver/drv/dw_ifc.c"
uint32_t csi_ifc_read(uint32_t addr, uint32_t size, uint32_t *ptrBuf)
{
 if (size<1) {
  return (0x81180000 | DRV_ERROR_PARAMETER);
...
# 194 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/csi_driver/drv/dw_ifc.c"
uint32_t csi_ifc_byte_read(uint32_t addr, uint32_t size, uint8_t *ptrBuf)
{
 if (size<1) {
  return (0x81180000 | DRV_ERROR_PARAMETER);
...
# 228 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/csi_driver/drv/dw_ifc.c"
uint32_t csi_ifc_page_erase(ifc_page_adr addr, uint32_t size)
{
 if (size<1 || size > 64) {
  return (0x81180000 | DRV_ERROR_PARAMETER);
...
# 264 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/csi_driver/drv/dw_ifc.c"
uint32_t csi_ifc_option_erase(void)
{
 ((H_IFC)->CEDR = 1ul);
 ((H_IFC)->KR = (0x5A5A5A5Aul));
 H_IFC->CMR = CMP_OPTERS | (1ul<<8);
 ((H_IFC)->CR = 1ul);
 while (H_IFC->CR != 0);
...
# 284 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/csi_driver/drv/dw_ifc.c"
uint32_t csi_ifc_user_option_set(uint32_t data)
{
 ((H_IFC)->CEDR = 1ul);
 ((H_IFC)->KR = (0x5A5A5A5Aul));
 ifc_update_addr_dr_cfg (0x0, data);
 H_IFC->CMR = CMP_PGMOPT | (1ul<<8);
 ((H_IFC)->CR = 1ul);
 while (H_IFC->CR != 0);
...
# 305 "G:/SW_HOME/CSKY/CSI/APT32F172A/CSI_APT32F172/Source/csi_driver/drv/dw_ifc.c"
