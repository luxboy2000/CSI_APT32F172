...
IncludePackagePath     :=
IncludeCPath           :=$(IncludePackagePath) $(IncludeSwitch)"$(ProjectPath)" $(IncludeSwitch)"$(ProjectPath)../../../Source/libs/include" $(IncludeSwitch)"$(ProjectPath)../../../Source/csi_driver/drv/include" $(IncludeSwitch)"$(ProjectPath)../../../Source/csi_driver/drv" $(IncludeSwitch)"$(ProjectPath)../../../Source/csi_driver/include" $(IncludeSwitch)"$(ProjectPath)../../../Source/csi_core/include" 
