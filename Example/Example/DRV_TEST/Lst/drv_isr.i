# 1 "G:/SW_HOME/CSKY/CSI/APT32F172A/drv/Source/csi_driver/drv/isr.c"
...
# 1 "<command-line>"
# 1 "G:/SW_HOME/CSKY/CSI/APT32F172A/drv/Source/csi_driver/drv/isr.c"
# 17 "G:/SW_HOME/CSKY/CSI/APT32F172A/drv/Source/csi_driver/drv/isr.c"
...
# 28 "F:/Appl/C-Sky/CDK/CSKY/csi/csi_driver/include/drv_common.h" 2
...
# 12 "f:\\appl\\c-sky\\cdk\\csky\\mingw\\csky-abiv2-elf-toolchain\\csky-elfabiv2\\sys-include\\errno.h" 2 3 4
...
# 18 "G:/SW_HOME/CSKY/CSI/APT32F172A/drv/Source/csi_driver/drv/isr.c" 2
...
# 19 "G:/SW_HOME/CSKY/CSI/APT32F172A/drv/Source/csi_driver/drv/isr.c" 2
...
# 20 "G:/SW_HOME/CSKY/CSI/APT32F172A/drv/Source/csi_driver/drv/isr.c" 2
...
__attribute__((weak)) void isr_syscon_irqhandler(void) {
...
__attribute__((weak)) void isr_adc_irqhandler(APT_ADC_Reg_t *handle) {
...
__attribute__((weak)) void isr_exi_irqhandler(uint32_t exi_num)
{
    H_SYSCON->EXICR = 0xffffffff;
}

__attribute__((weak)) void isr_usart_irqhandler(APT_USART_Reg_t *handle)
{
    handle->ICR = 0xffffffff;
}

__attribute__((weak)) void isr_uart_irqhandler(APT_UART_Reg_t *handle)
{
    handle->ISR = 0xffffffff;
}

__attribute__((weak)) void isr_i2c_irqhandler(APT_I2C_Reg_t *handle)
{
    handle->CR &= ~(0x1ul<<4);
}

__attribute__((weak)) void isr_spi_irqhandler(APT_SPI_Reg_t *handle)
{
    handle->ICR = 0xffffffff;
}
...
{
# 154 "G:/SW_HOME/CSKY/CSI/APT32F172A/drv/Source/csi_driver/drv/isr.c"
    ck_coret_irqhandler();
