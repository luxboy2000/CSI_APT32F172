...
//    csi_usart_putchar(console_handle, ch);
  ...
  1c:	6c0f      	mov      	r0, r3
  1e:	6fa3      	mov      	sp, r8
  20:	d90e2000 	ld.w      	r8, (sp, 0)
  24:	1401      	addi      	sp, sp, 4
  26:	783c      	rts
...
int fgetc(FILE *stream)
{
  ...
  2e:	6e3b      	mov      	r8, sp
  30:	1421      	subi      	sp, sp, 4
  32:	3300      	movi      	r3, 0
  34:	2b03      	subi      	r3, 4
  36:	60e0      	addu      	r3, r8
  38:	b300      	st.w      	r0, (r3, 0)
//    }
//
//    csi_usart_getchar(console_handle, &ch);
 ...
 //   return ch;
  ...
  3c:	6c0f      	mov      	r0, r3
  3e:	6fa3      	mov      	sp, r8
  40:	d90e2000 	ld.w      	r8, (sp, 0)
  44:	1401      	addi      	sp, sp, 4
  46:	783c      	rts
...
{
  48:	1421      	subi      	sp, sp, 4
  4a:	dd0e2000 	st.w      	r8, (sp, 0)
  4e:	6e3b      	mov      	r8, sp
  50:	1421      	subi      	sp, sp, 4
  52:	3300      	movi      	r3, 0
  54:	2b03      	subi      	r3, 4
  56:	60e0      	addu      	r3, r8
  58:	b300      	st.w      	r0, (r3, 0)
  ...
  5c:	6c0f      	mov      	r0, r3
  5e:	6fa3      	mov      	sp, r8
  60:	d90e2000 	ld.w      	r8, (sp, 0)
  64:	1401      	addi      	sp, sp, 4
  66:	783c      	rts
...
{
  68:	1421      	subi      	sp, sp, 4
  6a:	dd0e2000 	st.w      	r8, (sp, 0)
  6e:	6e3b      	mov      	r8, sp
  70:	1421      	subi      	sp, sp, 4
  72:	3300      	movi      	r3, 0
  74:	2b03      	subi      	r3, 4
  76:	60e0      	addu      	r3, r8
  78:	b300      	st.w      	r0, (r3, 0)
#ifndef CONFIG_KERNEL_NONE
  ...
  7c:	6c0f      	mov      	r0, r3
  7e:	6fa3      	mov      	sp, r8
  80:	d90e2000 	ld.w      	r8, (sp, 0)
  84:	1401      	addi      	sp, sp, 4
  86:	783c      	rts
