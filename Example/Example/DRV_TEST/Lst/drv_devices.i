# 1 "G:/SW_HOME/CSKY/CSI/APT32F172A/drv/Source/csi_driver/drv/devices.c"
...
# 1 "<command-line>"
# 1 "G:/SW_HOME/CSKY/CSI/APT32F172A/drv/Source/csi_driver/drv/devices.c"
# 17 "G:/SW_HOME/CSKY/CSI/APT32F172A/drv/Source/csi_driver/drv/devices.c"
...
# 18 "G:/SW_HOME/CSKY/CSI/APT32F172A/drv/Source/csi_driver/drv/devices.c" 2
# 30 "G:/SW_HOME/CSKY/CSI/APT32F172A/drv/Source/csi_driver/drv/devices.c"
APT_SYSCON_Reg_t * H_SYSCON = (APT_SYSCON_Reg_t *)((0x40000000UL)+0x11000UL);
APT_IFC_Reg_t * H_IFC = (APT_IFC_Reg_t *)((0x40000000UL)+0x10000UL);
APT_TKEY_Reg_t * H_TKEY = (APT_TKEY_Reg_t *)((0x40000000UL)+0x20000UL);
APT_ADC_Reg_t * H_ADC = (APT_ADC_Reg_t *)((0x40000000UL)+0x30000UL);
APT_TC0_Reg_t * H_TC0 = (APT_TC0_Reg_t *)((0x40000000UL)+0x50000UL);
APT_TC1_Reg_t * H_TC1 = (APT_TC1_Reg_t *)((0x40000000UL)+0x51000UL);
APT_TC2_Reg_t * H_TC2 = (APT_TC2_Reg_t *)((0x40000000UL)+0x52000UL);
APT_TC3_Reg_t * H_TC3 = (APT_TC3_Reg_t *)((0x40000000UL)+0x53000UL);
APT_EPWM_Reg_t * H_EPWM = (APT_EPWM_Reg_t *)((0x40000000UL)+0x54000UL);
APT_I2C_Reg_t * H_I2C = (APT_I2C_Reg_t *)((0x40000000UL)+0xA0000UL);
APT_SPI_Reg_t * H_SPI = (APT_SPI_Reg_t *)((0x40000000UL)+0x90000UL);
APT_USART_Reg_t * H_UART0 = (APT_USART_Reg_t *)((0x40000000UL)+0x80000UL);
APT_UART_Reg_t * H_UART1 = (APT_UART_Reg_t *)((0x40000000UL)+0x81000UL);
APT_LED_Reg_t * H_LED = (APT_LED_Reg_t *)((0x40000000UL)+0x60000UL);
APT_CMP_Reg_t * H_CMP = (APT_CMP_Reg_t *)((0x40000000UL)+0xB0000UL);
APT_OPA_Reg_t * H_OPA = (APT_OPA_Reg_t *)((0x40000000UL)+0xC0000UL);
